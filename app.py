...
# 1. Données avec Tickers robustes
data = {
    'Ticker': [
        'CW8.PA', 
        'PMEU.F',   # <--- Changement ICI : .F au lieu de .PA
        'ESE.PA', 
        'WPEA.PA'
    ],
...
# 2. Récupération simplifiée (plus rapide)
def get_live_price(ticker):
    try:
        t = yf.Ticker(ticker)
        # On demande l'historique très court pour forcer la mise à jour
